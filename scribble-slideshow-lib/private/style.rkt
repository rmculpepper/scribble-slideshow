...
(define initial-stylemap
  (hash
   ...
   "RktBlk"  `((ref rktfont) (iset white-space pre))
   "RktCmt"  `((ref rktfont) (iset color (#xC2 #x74 #x1F)))
   "RktErr"  `((ref rktfont) (ref italic) (iset color "red"))
   "RktIn"   `((ref rktfont) (iset color (#xCC #x66 #x33)))
   "RktKw"   `((ref rktfont) (iset color "black"))
   "RktMeta" `((ref rktfont) (iset color "black"))
   "RktMod"  `((ref rktfont))
   "RktOut"  `((ref rktfont) (iset color (#x96 #x00 #x96)))
   "RktOpt"  `((ref italic) (iset color "black"))
   "RktPn"   `((ref rktfont) (iset color (#x84 #x3C #x24)))
   "RktRes"  `((ref rktfont) (iset color (#x00 #x00 #xAF)))
   "RktRdr"  `((ref rktfont))
   "RktSym"  `((ref rktfont)
   ...
   "RktVar"  `((ref rktfont) (ref italic) (iset color (#x44 #x44 #x44)))
   "RktVal"  `((ref rktfont) (iset color (#x22 #x8B #x22)))
   ...
   "Rkt*Def"    `((ref rktfont) (iset color "black" text-mods (bold)))
